...
bool SettingsManager_::loadSettingsFromFile() {
    ...
    settings.alarm_no_data_snooze_interval = (*doc)["alarm_no_data_snooze_interval"].as<int>();
...
bool SettingsManager_::saveSettingsToFile() {
    ...
    (*doc)["alarm_no_data_snooze_interval"] = settings.alarm_no_data_snooze_interval;
